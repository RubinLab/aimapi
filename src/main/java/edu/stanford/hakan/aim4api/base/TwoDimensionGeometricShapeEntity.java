...
public class TwoDimensionGeometricShapeEntity extends GeometricShapeEntity {
    ...
    public boolean isEqualTo(Object other) {
        ...
        if (this.imageReferenceUid == null ? oth.imageReferenceUid != null : !this.imageReferenceUid.isEqualTo(oth.imageReferenceUid)) {
            return false;
        }
        ...
        if (this.twoDimensionSpatialCoordinateCollection == null ? oth.twoDimensionSpatialCoordinateCollection != null : !this.twoDimensionSpatialCoordinateCollection.isEqualTo(oth.twoDimensionSpatialCoordinateCollection)) {
            return false;
        }
